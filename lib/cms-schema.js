...
const rawGroups = [
  ...
  ['Paper Trail', 'Five cards in chronological order. Choose one card to highlight; add a link only where it helps.', [
    ...
    ['timeline-highlight', 'Highlighted card', 'three', 'select', [['one', 'Card 1'], ['two', 'Card 2'], ['three', 'Card 3'], ['four', 'Card 4'], ['five', 'Card 5'], ['six', 'Card 6']]],
    ...
    ['timeline-six-year', 'Card 6 year', '2026', 'short'],
    ['timeline-six-label', 'Card 6 label', 'New entry', 'short'],
    ['timeline-six-copy', 'Card 6 copy', 'Add a description for this date.', 'long'],
    ['timeline-six-link', 'Card 6 optional link', '', 'url']
  ]],
  ...
  ['The Record', 'The lead story, three "core record" cards (reorderable among themselves), and two "also in the record" cards (reorderable among themselves).', [
    ...
    ['record-one-order', 'Health care position', '1', 'select', [['1', '1st'], ['2', '2nd'], ['3', '3rd'], ['4', '4th']]],
    ...
    ['record-two-order', 'Retirement security position', '2', 'select', [['1', '1st'], ['2', '2nd'], ['3', '3rd'], ['4', '4th']]],
    ...
    ['record-three-order', 'Abortion rights position', '3', 'select', [['1', '1st'], ['2', '2nd'], ['3', '3rd'], ['4', '4th']]],
    ...
    ['record-six-order', 'New story position', '4', 'select', [['1', '1st'], ['2', '2nd'], ['3', '3rd'], ['4', '4th']]],
    ['record-six-kicker', 'New story label', 'New topic', 'short'],
    ['record-six-title', 'New story title', 'Add a headline', 'short'],
    ['record-six-copy', 'New story copy', 'Add a description for this story.', 'long'],
    ['new-story-image', 'New story image', image, 'image'],
