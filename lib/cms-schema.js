...
const rawGroups = [
  ...
  ['Paper Trail', 'Four cards in chronological order. Choose one card to highlight; add a link only where it helps.', [
    ['timeline-heading', 'Section heading', 'The Paper Trail', 'short'],
    ['timeline-highlight', 'Highlighted card', 'three', 'select', [['one', 'Card 1'], ['two', 'Card 2'], ['three', 'Card 3'], ['four', 'Card 4']]],
  ...
  ['The Record', 'The four issue entries and their images.', [
  ...
  ['Alternate designs', 'Extra copy used only by Designs 2–4 (case file, magazine, and scorecard). Not shown on the original Design 1.', [
    ['alt-topbar-note', 'Case-file top note (Design 2)', 'Opposition file · Public sources only', 'short'],
    ['alt-pull-quote', 'Pull quote (Design 3)', 'A label changed on a form. Nothing changed in the votes.', 'long'],
    ['alt-pull-quote-attribution', 'Pull quote attribution (Design 3)', '', 'short'],
    ['alt-receipt-label', 'Receipt title (Design 4)', 'The receipt', 'short'],
    ['alt-receipt-sublabel', 'Receipt subtitle (Design 4)', 'Itemized · public sources', 'short'],
    ['alt-receipt-total-label', 'Receipt total label (Design 4)', 'Alignment total', 'short']
  ]],
  ['Design picker', 'Choose which designs appear in the small switcher shown in the corner of every page. Hiding a design here only removes it from that switcher — the page itself is still reachable by its direct URL.', [
    ['design-1-visibility', 'Design 1 (original) in switcher', 'hide', 'select', [['show', 'Visible'], ['hide', 'Hidden']]],
    ['design-2-visibility', 'Design 2 (case file) in switcher', 'hide', 'select', [['show', 'Visible'], ['hide', 'Hidden']]],
    ['design-3-visibility', 'Design 3 (magazine) in switcher', 'hide', 'select', [['show', 'Visible'], ['hide', 'Hidden']]],
    ['design-4-visibility', 'Design 4 (scorecard) in switcher', 'hide', 'select', [['show', 'Visible'], ['hide', 'Hidden']]],
    ['design-5-visibility', 'Design 5 (hybrid) in switcher', 'show', 'select', [['show', 'Visible'], ['hide', 'Hidden']]]
  ]],
