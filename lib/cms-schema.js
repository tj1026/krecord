...
const rawGroups = [
  ...
  ['Paper Trail', 'Four cards in chronological order. Choose one card to highlight; add a link only where it helps.', [
    ...
    ['timeline-five-year', 'Card 5 year', '2026', 'short'],
    ['timeline-five-label', 'Card 5 label', 'New entry', 'short'],
    ['timeline-five-copy', 'Card 5 copy', 'Add a description for this date.', 'long'],
    ['timeline-five-link', 'Card 5 optional link', '', 'url']
  ]],
  ...
  ['The Record', 'The four issue entries and their images.', [
    ...
    ['record-four-kicker', 'New story label', 'New topic', 'short'],
    ['record-four-title', 'New story title', 'Add a headline', 'short'],
    ['record-four-copy', 'New story copy', 'Add a description for this story.', 'long'],
  ...
  ['Closing', 'The final call to action and footer.', [
    ...
    ['closing-copy-link', 'Closing copy link', '', 'url'],
